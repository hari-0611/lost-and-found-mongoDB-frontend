...
export class ItemDetailsComponent {
  ...
  ngOnInit(): void {
    ...
    if(this.isLostItem){
      console.log('Fetching lost item details',this.itemId);
      this.apiService.getItemById(this.itemId).subscribe(data=>{
        ...
        // this.item[0].dateLost = this.item[0].dateLost.slice(0, 10);
        // this.item.imageUrl = this.item[0].imageUrl ? `${baseUrl}${this.item[0].imageUrl}` : null
